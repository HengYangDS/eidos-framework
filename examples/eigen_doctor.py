...
DOCS_ROOT = Path(r"C:\Users\Administrator\projects\sage-kb\docs\eigen")
...
def check_index_links():
    ...
    for link in links:
        ...
        # Index is at docs/eigen/00_INDEX.md
...
def main():
    print("=== EIGEN DOCUMENTATION DOCTOR ===")
    total_errors = 0
