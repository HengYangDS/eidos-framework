...
from eidos.techne.sources.sql_source import SQLServerSource
from eidos.techne.detectors.filters import SZStockDetector
from eidos.techne.emitters.csv_sink import CSVSink

async def main():
    print("=== Project EIDOS: Full Link Capability Proof ===\n")
    
    # 1. Configure [Source]
    # SQL file is stored under repo_root/src/eidos/scripts
    sql_file = REPO_ROOT / "src/eidos/scripts/dz_daily.sql"
    db_config = {
        "host": "dbs.cfi",
        "user": "public_data",
